...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _businessman = __webpack_require__(1);

	_businessman.worker.registerStore({
	    type: 'counter',
	    state: 0,
	    mutations: {
	    ...
	    actions: {
	        increment: function increment(commit) {
	    ...
	    getters: {
	        absolute: function absolute(state) {
	            return Math.abs(state);
	        }
	    }
	});

	_businessman.worker.start();
